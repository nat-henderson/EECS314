...
public class InstructionDbHelper {
	public static final String KEY_TITLE = "title";
	public static final String KEY_BODY = "body";
	public static final String KEY_ROWID = "_id";
	
	private static final String TAG = "InstructionDbHelper";
	...
	public InstructionDbHelper open() throws SQLException {
	...
	public long createFile(String title, String body) {
